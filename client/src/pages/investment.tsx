    ...
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">Contact our founder</p>
        </div>
        ...
        <Card className="border-2 border-yellow-400/50 bg-gradient-to-br from-slate-900 to-slate-800 shadow-2xl shadow-yellow-500/20 mb-6">
          <CardHeader className="bg-gradient-to-r from-yellow-400 to-amber-500 text-slate-900 rounded-t-lg">
            ...
            <p className="text-sm font-semibold text-slate-800 mt-2">Founder & Developer</p>
          </CardHeader>
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="flex items-start gap-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-white/60 font-medium mb-1">Email</p>
                <a
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                ...
                <div className="flex-1">
                  <p className="text-xs text-white/60 font-medium mb-1">Mobile 1</p>
                  <a
              ...
              <div className="flex items-start gap-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                <Phone className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <p className="text-xs text-white/60 font-medium mb-1">Mobile 2</p>
                  <a
            ...
            <div className="flex items-start gap-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
              ...
              <div className="flex-1">
                <p className="text-xs text-white/60 font-medium mb-1">Location</p>
                <p className="text-sm text-white">District Budaun, Uttar Pradesh, India</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="bg-blue-900/30 border border-blue-400/50 rounded-lg p-4 text-center">
          <p className="text-sm text-blue-200">
            Feel free to reach out for investment opportunities and partnerships!
          </p>
        </div>
      </div>
    </div>
